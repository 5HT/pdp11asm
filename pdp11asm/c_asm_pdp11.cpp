...
void AsmPdp11::call(unsigned addr)
{
    c.out.write16(004000|(/*PC*/7<<6)|(/*PC*/7<<3)|(2));
    c.out.write16(addr);
}

//---------------------------------------------------------------------------------------------------------------------

void AsmPdp11::call(const char* name)
{
    c.out.write16(004000|(/*PC*/7<<6)|(2<<3)|(/*PC*/7));
    c.addFixup(ucase(name)); //! Так нельзя
    c.out.write16(0);
}
